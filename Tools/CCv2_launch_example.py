...
dict_to_pickle = {'StagingWiki.Article writing how-to.Test page for macro testing.WebHome': 'xwiki'}
...
def start_core_as_subprocess(dict_to_pickle: dict):
    try:
        ...
        subprocess.call("python " + str(locality.cc_path)+"CCv2.1.py DEBUG True -b" + temp_id, shell=True)
        return True
    except:
        return False
