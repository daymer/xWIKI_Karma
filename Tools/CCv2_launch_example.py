...
dict_to_pickle = {'Main.Bugs and Fixes.Found Bugs.Veeam ONE.Veeam ONE v9\.5 Bugs.WebHome': 'xwiki'}
...
def start_core_as_subprocess(dict_to_pickle: dict):
    ...
    subprocess.call("python C:/Projects/xWIKI_Karma/Comparer_core_v2_0.py DEBUG True -b" + temp_id, shell=True)
