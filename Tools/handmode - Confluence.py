...
CurrentPage = PAGE_CREATOR.create_new_page_by_title_and_platform('Resolving “ Error: The process cannot access the file because it is being used by another process.”', 'Confluence')
