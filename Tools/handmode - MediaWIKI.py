...
xWikiConfig = Configuration.xWikiConfig(['Main', 'Sandbox'])
...
CurrentPage = PAGE_CREATOR.create_new_page_by_title_and_platform('Test page to check page rank', 'MediaWIKI')
