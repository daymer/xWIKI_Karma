--EXEC [dbo].[get_user_karma_current_score] @user_id = 'B59CA9D0-16EC-4E27-86F7-D8D81843E0BE'
...
set @id = 'B59CA9D0-16EC-4E27-86F7-D8D81843E0BE'
...
select @page_id, @up as 'up', @down as 'down',((@up-@down)* @persent) as 'summary', @karma_total_score as 'current karma'
END
FETCH NEXT FROM @CURSOR INTO @page_id, @persent
END
CLOSE @CURSOR
